...
const plans = [
    {
        ...
        buttonClasses: "hover:brightness-110 text-[#333333] shadow-xl shadow-[#4DA8C5]/20",
        buttonStyle: { background: 'linear-gradient(90deg, #CFF63D 0%, #4DA8C5 100%)' },
        footerText: "Possibilità di abbonamento semestrale a 25,90 mese\nOfferta valida fino a 250mq\nPagamento unica soluzione",
        highlight: false,
    }
];

export function Pricing2026_02() {
    return (
        <section id="pricing" className="bg-gradient-to-b from-[#333333] via-[#1a1a1a] to-black pt-2 md:pt-16 pb-8 px-6 md:px-12 overflow-hidden">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16 space-y-4">
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-[#CFF63D] leading-[1.1] tracking-tight">
                        QUANTO MI COSTA?
                    </h2>
                    ...
                    {plans.map((plan, i) => (
                        <motion.div
                            ...
                            className={`flex flex-col lg:flex-row bg-white rounded-3xl overflow-hidden shadow-2xl transition-all w-full
                                ${plan.highlight ? 'ring-4 ring-[#E84F9A] ring-offset-4 ring-offset-black scale-100 lg:scale-105 z-10' : 'scale-100'}`}
                        >
                            {/* Color Header */}
                            <div
                                className={`px-6 pt-10 pb-8 lg:p-12 text-center lg:text-left min-h-[170px] flex flex-col justify-center lg:w-1/3 shrink-0 bg-[#4DA8C5]`}
                            >
                                <h3 className={`text-4xl lg:text-5xl font-black uppercase tracking-wide mb-4 text-[#333333]`}>
                                    {plan.name}
                                </h3>
                                {plan.subtitle && (
                            ...
                            <div className="p-6 md:p-8 lg:p-12 flex flex-col lg:flex-row gap-8 lg:gap-12 w-full">
                                ...
                                <div className="flex flex-col lg:w-1/3 shrink-0 lg:border-r border-zinc-200 lg:pr-8">
                                    <div className="text-center mb-6 lg:mb-8 min-h-[90px] flex items-center justify-center w-full">
                                        {plan.price && (
                                            <div className="flex flex-col items-center justify-center text-[#637BD0] font-black w-full text-center pr-6 lg:pr-0">
                                                ...
                                                <span className="text-[#E84F9A] text-lg md:text-md font-bold mt-1 uppercase tracking-wide block text-center w-full">{plan.period}</span>
                                            </div>
                                        )}
                                    </div>
                                    ...
                                    <div className="mt-8 lg:mt-auto space-y-6">
                                        <div className="flex justify-center w-full px-0 sm:px-0">
                                            <Link href="#trial-form" className="w-[110%] sm:w-full -ml-[5%] sm:ml-0">
                                                <Button
                                                    className={`w-full rounded-md h-auto py-5 sm:py-5 px-1 sm:px-4 text-[12px] sm:text-[16px] font-black uppercase tracking-widest text-center whitespace-normal min-w-0 leading-[1.3] transition-all bg-[#CFF63D] hover:bg-[#637BD0] text-[#333333] hover:text-white ${plan.buttonClasses}`}
                                                >
                                                    {plan.buttonText}
                                                </Button>
                                            </Link>
                                        ...
                                        <p className="text-center lg:text-left text-xs text-[#333333] font-medium whitespace-pre-line leading-relaxed pb-2">
                                            {plan.footerText}
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <ul className="space-y-6 my-auto">
                                        {plan.features.map((feat, idx) => (
                                            <li key={idx} className="flex items-start gap-4">
                                                <div className={`mt-1.5 bg-[#637BD0] shadow-sm rounded-full shrink-0 flex items-center justify-center w-[15px] h-[15px]`}>
                ...
                >
                    {/* LASER CHANNEL */}
                    <div className="flex-1 bg-white rounded-[20px] md:rounded-3xl p-8 flex flex-col justify-center items-center text-center shadow-xl relative overflow-hidden border border-[#C6ABDE]">
                        <div className="absolute inset-0 flex items-center justify-center opacity-[0.05] pointer-events-none">
                            <div className="w-64 h-64 border-[8px] border-[#637BD0] rotate-45 rounded-3xl"></div>
                        </div>
                        <h3 className="text-2xl md:text-3xl font-black text-[#637BD0] tracking-wide mb-3 relative z-10 uppercase">
                            LASER CHANNEL
                        </h3>
                        <p className="text-[#333333] text-[15px] md:text-lg font-medium leading-snug relative z-10 transition-all">
                            *Lo ottieni con il piano <span className="text-[#E84F9A] font-bold">Premium</span>.<br />
                    ...
                    {/* COSMETIC CHANNEL */}
                    <div className="flex-1 bg-gradient-to-b from-[#637BD0] to-[#E84F9A] rounded-[20px] md:rounded-3xl p-8 flex flex-col justify-center items-center text-center shadow-xl relative overflow-hidden border border-white/10">
                        <div className="absolute inset-0 flex items-center justify-center opacity-[0.05] pointer-events-none">
                        ...
                        <p className="text-white text-[15px] md:text-lg font-medium leading-snug drop-shadow-sm relative z-10 transition-all">
                            **Incluso nel piano <span className="text-[#CFF63D] font-bold">Premium</span><br />
                ...
                >
                    ...
                    <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                        {[
                            ...
                            <div key={item.step} className="bg-[#111111] border border-white/10 rounded-[20px] p-8 text-center shadow-xl space-y-4">
                                <span className="block text-6xl font-black text-[#CFF63D] mb-6 drop-shadow-sm">
                                    {item.step}
                                </span>
                    ...
                    <div className="flex justify-center pt-8">
                        <Link href="#trial-form">
                            <Button
                                className="bg-[#CFF63D] hover:bg-[#E84F9A] text-[#333333] hover:text-white font-black text-sm md:text-base px-8 py-6 rounded-md uppercase tracking-wide shadow-[0_8px_30px_rgba(207,246,61,0.4)] transition-all border-none"
                            >
                ...
                >
                    ...
                    <p className="text-[#CFF63D] max-w-4xl mx-auto text-2xl md:text-4xl font-light italic tracking-wider drop-shadow-md">
