...
const plans = [
    {
        ...
        buttonClasses: "hover:brightness-110 text-[#38231F] shadow-xl shadow-[#D4AF37]/20",
        buttonStyle: { background: 'linear-gradient(90deg, #D4AF37 0%, #F3F1ED 100%)' },
...
export function Pricing2026_03() {
    return (
        <section id="pricing" className="bg-gradient-to-b from-[#D4AF37] via-[#38231F] to-black pt-2 md:pt-16 pb-8 px-6 md:px-12 overflow-hidden">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16 space-y-4">
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-[#F3F1ED] leading-[1.1] tracking-tight">
                        QUANTO MI COSTA?
                    </h2>
                ...
                <div className="flex justify-center max-w-sm lg:max-w-5xl mx-auto">
                    {plans.map((plan, i) => (
                        <motion.div
                            ...
                            className={`flex flex-col lg:flex-row bg-[#F3F1ED] rounded-3xl overflow-hidden shadow-2xl transition-all w-full
                                ${plan.highlight ? 'ring-4 ring-[#D1A1AE] ring-offset-4 ring-offset-black scale-100 lg:scale-105 z-10' : 'scale-100'}`}
                        >
                            {/* Color Header */}
                            <div
                                className={`px-6 pt-10 pb-8 lg:p-12 text-center lg:text-left min-h-[170px] flex flex-col justify-center lg:w-1/3 shrink-0 bg-[#7E415F]`}
                            >
                                <h3 className={`text-4xl lg:text-5xl font-black uppercase tracking-wide mb-4 text-[#F3F1ED]`}>
                                    {plan.name}
                                </h3>
                                {plan.subtitle && (
                                    <p className={`text-base md:text-lg lg:text-xl font-medium leading-relaxed whitespace-pre-line text-[#D9C3B0]`}>
                                        {plan.subtitle}
                                    </p>
                                )}
                            </div>
                            ...
                            <div className="p-6 md:p-8 lg:p-12 flex flex-col lg:flex-row gap-8 lg:gap-12 w-full">
                                ...
                                <div className="flex flex-col lg:w-1/3 shrink-0 lg:border-r border-[#D9C3B0] lg:pr-8">
                                    <div className="text-center mb-6 lg:mb-8 min-h-[90px] flex items-center justify-center w-full">
                                        {plan.price && (
                                            <div className="flex flex-col items-center justify-center text-[#7E415F] font-black w-full text-center pr-6 lg:pr-0">
                                                ...
                                                <span className="text-[#38231F] text-lg md:text-md font-bold mt-1 uppercase tracking-wide block text-center w-full">{plan.period}</span>
                                            </div>
                                        )}
                                    </div>
                                    ...
                                    <div className="mt-8 lg:mt-auto space-y-6">
                                        ...
                                        <p className="text-center lg:text-left text-xs text-[#38231F] font-medium whitespace-pre-line leading-relaxed pb-2">
                                            {plan.footerText}
                                        </p>
                                    </div>
                                </div>
                                        ...
                                        {plan.features.map((feat, idx) => (
                                            <li key={idx} className="flex items-start gap-4">
                                                <div className={`mt-1.5 bg-[#D4AF37] shadow-sm rounded-full shrink-0 flex items-center justify-center w-[15px] h-[15px]`}>
                                                    <Check className="w-[10px] h-[10px] text-[#38231F] stroke-[3.5]" />
                                                </div>
                                                <span className="text-[#38231F] font-medium leading-[1.6] text-[14px] lg:text-[15px]">
                                                    {feat}
                                                </span>
                                            </li>
                                        ))}
                ...
                >
                    {/* LASER CHANNEL */}
                    <div className="flex-1 bg-[#F3F1ED] rounded-2xl md:rounded-3xl p-6 md:p-8 flex flex-col justify-center items-center text-center shadow-xl relative overflow-hidden border border-[#D9C3B0]">
                    ...
                    {/* COSMETIC CHANNEL */}
                    <div className="flex-1 bg-gradient-to-b from-[#7E415F] to-black rounded-2xl md:rounded-3xl p-6 md:p-8 flex flex-col justify-center items-center text-center shadow-xl relative overflow-hidden border border-white/10">
                        <div className="absolute inset-0 flex items-center justify-center opacity-[0.05] pointer-events-none">
                ...
                >
                    ...
                    <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                        {[
                            ...
                            <div key={item.step} className="bg-[#111111]/80 border border-[#7E415F]/30 rounded-[20px] p-8 text-center shadow-xl space-y-4">
                                <span className="block text-6xl font-black text-[#D4AF37] mb-6 drop-shadow-sm">
                                    {item.step}
                                </span>
                                <p className="text-[#D9C3B0] font-bold text-[15px] leading-snug">
                                    {item.text}
                                </p>
                            </div>
                        ))}
                    ...
                    <div className="flex justify-center pt-8">
                        <Link href="#trial-form">
                            <Button
                                className="bg-[#D4AF37] hover:bg-[#38231F] text-[#38231F] hover:text-[#F3F1ED] font-black text-sm md:text-base px-8 py-6 rounded-md uppercase tracking-wide shadow-[0_8px_30px_rgba(212,175,55,0.4)] transition-all border-none"
                            >
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-black mb-2 text-[#F3F1ED] leading-tight tracking-tight">
                        Con BeautiFy acquisisci un potente, elegante<br className="hidden md:block" />
                        strumento di vendita e promozione che...
                    </h2>
                    <p className="text-[#D4AF37] max-w-4xl mx-auto text-2xl md:text-4xl font-light italic tracking-wider drop-shadow-md">
                ...
                <motion.div
                    ...
                    viewport={{ once: true, margin: "-100px" }}
                    transition={{ duration: 0.8 }}
                    className="pt-16 pb-0 flex flex-col items-center justify-center text-center space-y-6 border-t border-[#38231F]/50"
                >
                    ...
                    <a
                        ...
                        className="inline-flex items-center justify-center bg-[#25D366] hover:bg-[#20bd5a] text-[#38231F] font-bold text-lg md:text-xl rounded-full px-10 py-4 shadow-[0_0_20px_rgba(37,211,102,0.4)] transition-all hover:scale-105 gap-3"
                    >
