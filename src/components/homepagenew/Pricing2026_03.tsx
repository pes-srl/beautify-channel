    ...
    return (
        <section id="pricing" className="bg-gradient-to-b from-[#D4AF37] via-[#38231F] to-black pt-2 md:pt-16 pb-8 px-6 md:px-12 overflow-hidden">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    {/* LASER CHANNEL */}
                    <div className="flex-1 bg-[#F3F1ED] rounded-[20px] md:rounded-3xl p-8 flex flex-col justify-center items-center text-center shadow-xl relative overflow-hidden border border-[#D9C3B0]">
                    ...
                    {/* COSMETIC CHANNEL */}
                    <div className="flex-1 bg-gradient-to-b from-[#7E415F] to-black rounded-[20px] md:rounded-3xl p-8 flex flex-col justify-center items-center text-center shadow-xl relative overflow-hidden border border-white/10">
                        <div className="absolute inset-0 flex items-center justify-center opacity-[0.05] pointer-events-none">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                        {[
                            ...
                            <div key={item.step} className="bg-[#111111]/80 border border-[#7E415F]/30 rounded-[20px] p-8 text-center shadow-xl space-y-4">
                                ...
                                <p className="text-[#D9C3B0] font-bold text-lg md:text-xl leading-snug">
                                    {item.text}
                                </p>
                            </div>
                        ))}
