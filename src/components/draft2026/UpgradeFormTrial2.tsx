          ...
          <form action={handleSubmit} className="space-y-6">
              ...
              <div className="md:col-span-2 mb-2">
                ...
                <div className="flex bg-black/40 p-1 rounded-xl border border-white/10 w-full mb-2">
                  ...
                  <label className="flex-1 relative cursor-pointer text-center">
                    ...
                    />
                    <div className="py-2.5 px-4 rounded-lg font-bold text-sm text-zinc-400 peer-checked:bg-amber-400 peer-checked:text-zinc-950 transition-all peer-checked:shadow-md">
                      Premium
                    </div>
                  </label>
                </div>
            ...
            <div className="pt-4 flex justify-center w-full">
              <Button
                ...
                className="bg-gradient-to-r from-[#AB7169] to-[#AB7169] hover:from-[#AB7169] hover:to-white text-white font-bold font-[family-name:var(--font-montserrat)] py-6 px-10 rounded-xl text-lg shadow-[0_0_20px_rgba(45,212,191,0.4)] transition-all disabled:opacity-50 border-none"
              >
                {isSubmitting
