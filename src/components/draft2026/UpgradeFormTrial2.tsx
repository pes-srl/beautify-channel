...
export function UpgradeFormTrial2({ userEmail }: { userEmail?: string }) {
  ...
  const handleNextStep = (e: React.MouseEvent) => {
    e.preventDefault();
    const container = document.getElementById('step-1-container-trial2');
    if (container) {
          ...
          <form action={handleSubmit} className="space-y-6">
            ...
            <div className="overflow-hidden relative w-full">
              ...
              >
                ...
                <div id="step-1-container-trial2" className="w-full shrink-0 grid grid-cols-1 md:grid-cols-2 gap-6 p-1">
                ...
                <div id="step-2-container-trial2" className="w-full shrink-0 grid grid-cols-1 md:grid-cols-2 gap-6 p-1">
