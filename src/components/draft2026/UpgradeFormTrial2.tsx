          ...
          <form action={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2 mb-2 text-center py-4">
                <div className="inline-block px-6 py-2.5 bg-[#D8B2A3]/20 text-[#D8B2A3] border border-[#D8B2A3]/50 rounded-lg font-bold font-[family-name:var(--font-montserrat)] tracking-wide shadow-[0_0_15px_rgba(216,178,163,0.2)]">
              ...
              <div className="md:col-span-2 mt-4 mb-2 flex justify-center text-center">
                <div className="bg-black/30 border border-[#D8B2A3]/20 rounded-2xl p-6 w-full max-w-sm shadow-[0_0_15px_rgba(16,185,129,0.1)]">
                  ...
                  <p className={`font-bold mb-3 uppercase tracking-wide ${requestedPlan === 'basic' ? 'text-[#D8B2A3]' : 'text-[#D8B2A3]'}`}>Piano Basic</p>
