              ...
              <div className="flex bg-black/40 p-1 rounded-xl border border-white/10 w-full mb-2">
                <label className="flex-1 relative cursor-pointer text-center">
                  <input
                    ...
                    defaultChecked
                  />
                  <div className="py-2.5 px-4 rounded-lg font-bold text-sm text-zinc-400 peer-checked:bg-fuchsia-600 peer-checked:text-white transition-all peer-checked:shadow-md">
                    Basic
                  </div>
                </label>
                <label className="flex-1 relative cursor-pointer text-center">
