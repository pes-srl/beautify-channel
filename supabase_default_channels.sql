-- BEAUTIFY CHANNEL: DEFAULT CHANNELS & TRIGGER RESTORE
...
-- 3. Mark the 6 specific channels as default (and ensure they exist)
-- This tries to update them, or insert them if they don't exist
INSERT INTO public.radio_channels (name, stream_url, min_tier_required, is_active, is_default)
VALUES 
...
ON CONFLICT DO NOTHING; -- Assuming you'll configure URLs later, or we update by name
